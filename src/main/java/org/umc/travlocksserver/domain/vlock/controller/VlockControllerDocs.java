...
public interface VlockControllerDocs {
	...
	@Operation(summary = "블록 검색", description = """
		키워드를 사용하여 블록을 검색합니다.
	...
	@Operation(summary = "블록 생성", description = """
		템플릿에 사용될 블록을 생성합니다.
	...
	@Operation(summary = "인기 블록 조회", description = """
	...
	@Operation(summary = "카테고리 블록 조회", description = """
	...
	@Operation(summary = "내가 생성한 블록 조회", description = """
	...
	@Operation(summary = "블록 수정", description = """
	...
	@Operation(summary = "블록 삭제", description = """
		사용자가 생성한 블록을 삭제합니다.
