...
public class TemplateController implements TemplateControllerDocs {
	...
	@PatchMapping(value = "/{templateId}", consumes = MediaType.MULTIPART_FORM_DATA_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@Override
	public ResponseEntity<SuccessResponse<TemplateDetailResponseDTO>> getTemplateDetail(@PathVariable
	Long templateId, @Parameter(hidden = true) @LoginUser
	Member member) {
	...
	@PostMapping("/{templateId}/days/{dayNo}/optimize")
