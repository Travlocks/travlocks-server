package org.umc.travlocksserver.domain.traveltheme.code;
...
public enum TravelThemeErrorCode implements BaseCode {
    ...
    INVALID_PREFERRED_THEME_REQUEST(HttpStatus.BAD_REQUEST, "preferredTravelThemeIds는 null을 허용하지 않습니다. (필드 생략=유지, []=해제)"),
    ;
